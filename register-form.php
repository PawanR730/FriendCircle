...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join Friend Circle - A Social Media App</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="register.php" method="post">
					...
					<a style="text-decoration: none;float: right;color: #187FAB;" data-toggle="tooltip" title="Signin" href="login-form.php">Already have an account?</a><br><br>

					<center><button id="signup" class="btn btn-info btn-lg" name="register">Signup</button></center>
